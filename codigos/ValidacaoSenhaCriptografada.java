...
public class ValidacaoSenhaCriptografada {
    ...
    private static void autenticarUsuario() {
        ...
        while (tentativas < 3) {
            System.out.print("Digite a senha: ");
            String senha = scanner.nextLine();
            if (usuarios.containsKey(nome) && usuarios.get(nome).equals(criptografarSenha(senha))) {
    ...
    private static String criptografarSenha(String senha) {
        ...
        for (char caractere : senha.toCharArray()) {
            senhaCriptografada.append((char) (caractere + 10));
        }
        return senhaCriptografada.toString();
    }

    // Supondo que você queira implementar uma função de descriptografia
    private static String descriptografarSenha(String senhaCriptografada) {
        ...
        for (char caractere : senhaCriptografada.toCharArray()) {
            senhaDescriptografada.append((char) (caractere - 10));
        }
